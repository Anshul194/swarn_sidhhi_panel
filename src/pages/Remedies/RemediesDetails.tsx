...
const RemediesDetails: React.FC = () => {
  const location = useLocation();
  const remedy = location.state?.remedy || "Remedy";

  return (
    <div className="min-h-screen rounded-2xl border border-gray-200 bg-white px-8 py-8 xl:px-10 xl:py-12 mx-auto">
      {/* Page Title */}
      <h1 className="text-2xl font-bold text-center mb-8">Remedy: {remedy}</h1>
      ...
      <div className="grid grid-cols-2 gap-6 mb-8">
        ...
        <div className="border rounded-lg p-5">
          <h3 className="font-semibold mb-2">Career Remedy (English)</h3>
          <p>
        ...
        <div className="border rounded-lg p-5">
          <h3 className="font-semibold mb-2">Career Remedy (Hindi)</h3>
          <p>
            <span className="font-bold">Lorem Ipsum</span> is simply dummy text
            of the printing and typesetting industry.
          </p>
      ...
      <div className="grid grid-cols-2 gap-6 mb-8">
        ...
        <div className="border rounded-lg p-5">
          <h3 className="font-semibold mb-2">Health Remedy (English)</h3>
          <p>
            <span className="font-bold">Lorem Ipsum</span> is simply dummy text
            of the printing and typesetting industry.
          </p>
        ...
        <div className="border rounded-lg p-5">
          <h3 className="font-semibold mb-2">Health Remedy (Hindi)</h3>
          <p>
            <span className="font-bold">Lorem Ipsum</span> is simply dummy text
            of the printing and typesetting industry.
          </p>
