...
import { createRajyog } from "../../../../store/slices/rajyogSlice";

const AddRajyog: React.FC = () => {
  const dispatch = useDispatch();
  const { loading, error } = useSelector((state: RootState) => state.rajyog); // Updated selector
