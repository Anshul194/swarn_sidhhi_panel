...
import { createEntrance } from "../../../../store/slices/vastuEntranceAnalysisSlice";

const AddVastuEntrance: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    dispatch(
      ...
      if (createEntrance.fulfilled.match(action)) {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 bg-white shadow-md rounded-lg">
      <h2 className="text-3xl font-bold mb-6 text-gray-800 flex items-center gap-2">
        ...
        Add vastu Entrance - Markdown Editor
      </h2>
...
export default AddVastuEntrance;
