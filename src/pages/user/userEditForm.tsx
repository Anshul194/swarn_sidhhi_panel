...
import { User, Mail, Phone, MapPin, Settings, Shield, Star, Calendar, Clock, Globe } from "lucide-react";
    ...
    useEffect(() => {
        if (userDetails) {
            setForm((prev) => ({
                ...prev,
                ...userDetails,
                // Map API fields to form fields if needed
                // e.g. username: userDetails.username || userDetails.user_name,
            }));
        }
    }, [userDetails]);
    ...
    const InputField = ({ label, name, type = "text", placeholder, required = false, icon: Icon, ...props }) => (
        <div className="space-y-2">
            ...
            <div className="relative">
                ...
                <input
                    className={`w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 ${Icon ? 'pl-12' : ''}`}
                    name={name}
                    type={type}
                    ...
                    <div className="bg-gray-50 p-6 rounded-lg">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-4">
                                <h3 className="text-lg font-medium text-gray-800">User Permissions</h3>
                            ...
                            <div className="space-y-4">
                                ...
                                <CheckboxField label="Currently Logged Out" name="isLoggedOut" />
                                <CheckboxField label="Test User" name="isTestUser" />
                                <CheckboxField label="Blocked Account" name="isBlocked" />
                                <CheckboxField label="Entered Referral Code" name="didEnteredReferralCode" />
                            </div>
                        </div>
                    </div>
                )}
